...
import { WorkShort, WorkPicture } from './../work.model';
...
export class WorkListComponent implements OnInit {
  ...
  constructor(
    ...
    isSelected(work: WorkShort) {
      return work.id === this.selectedId;
    }

    ngOnInit(): void {
        this.works = this.route.params
          .switchMap((params: Params) => {
            this.selectedId = +params['id'];
            return this.service.getWorks();
          });
    }
